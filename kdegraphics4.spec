...
# fwang: 4.6.4 includes an outdated okular snapshot
# the new tarball is generated by:
# git clone git://anongit.kde.org/okular
# cd okular
# git archive --prefix=okular/ --format=tar origin/4.6 |xz>../okular-0.12.4.tar.xz
...
%else
%setup -q -n kdegraphics-%version -a1
%endif
